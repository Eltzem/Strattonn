...
gen.searchVerbose('VTI', 'TIME_SERIES_INTRADAY', '1min','searches/search-dnn-stock-40-8-8-4-10-5-5hl', _numberToSave=5, _generations=100, _epochs=5, _batchSize=100, _maxHL=5, _initialPopulation=None, _goodLoss = 0.000007, _goodDA = 0.53)
